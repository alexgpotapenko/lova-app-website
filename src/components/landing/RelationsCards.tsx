...
export default function RelationsCards() {
  return (
    <div className="mt-16 flex flex-col gap-[96px]">
      ...
      >
        <div className="relative z-10 flex min-w-0 flex-col gap-5 rounded-card-40 bg-white p-6">
        ...
        <div className="relative z-0 min-w-0 overflow-hidden rounded-card-40 px-4 pt-4 shadow-[0_0_80px_rgba(0,0,0,0.06)]">
